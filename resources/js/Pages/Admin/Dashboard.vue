    ...
    datasets: [
        {
            ...
            data: [
                716, 1185, 750, 1365, 956, 890, 1200, 968, 1158, 1025, 920,
                1190, 720, 1352,
            ],
        },
    ],
            ...
            >
                <div class="flex-grow-1 mb-1 mb-md-0">
                    ...
                    <h2 class="h6 fw-medium fw-medium text-muted mb-0">
                        Welcome
                        <Link
                            :href="{ name: 'backend-pages-generic-profile' }"
                            class="fw-semibold"
                            >John</Link
                    ...
                    <BaseBlock class="d-flex flex-column h-100 mb-0">
                        <template #content>
                            ...
                            >
                                ...
                                <div class="item item-rounded-lg bg-body-light">
                                    <i
                                        class="far fa-user-circle fs-3 text-primary"
                                    ></i>
                                </div>
                            </div>
                            <div class="bg-body-light rounded-bottom">
                    ...
                    <BaseBlock class="d-flex flex-column h-100 mb-0">
                        <template #content>
                            ...
                            >
                                ...
                                <div class="item item-rounded-lg bg-body-light">
                                    <i
                                        class="far fa-paper-plane fs-3 text-primary"
                                    ></i>
                                </div>
                            </div>
                            <div class="bg-body-light rounded-bottom">
                                ...
                                <div class="row items-push text-center w-100">
                                    <div class="col-sm-4">
                                        <dl class="mb-0">
                                            ...
                                            >
                                                <i
                                                    class="fa fa-caret-up fs-base text-success"
                                                ></i>
                                                <span>2.5%</span>
                                            </dt>
                                            <dd
                                    ...
                                    <div class="col-sm-4">
                                        <dl class="mb-0">
                                            ...
                                            >
                                                <i
                                                    class="fa fa-caret-down fs-base text-danger"
                                                ></i>
                                                <span>1.7%</span>
                                            </dt>
                                            <dd
