                ...
                <div class="row g-0 justify-content-center text-center">
                    <div class="col-md-10 pt-7 pb-9">
                        ...
                        <p class="fs-5 fw-medium text-muted mb-5 mx-xl-8">
                            ...
                            developers and web agencies. Now based on
                            <span class="text-body-color fw-semibold"
                                >Vue.js 3</span
                            >, with
                            <span class="text-body-color fw-semibold"
                                >OneUI 5 design</span
                            ...
                            <span class="text-body-color fw-semibold"
                                >Bootstrap 5</span
                            >
                            in core. Comes packed with brand new libraries and
                            tooling, including
            ...
            <div class="content content-full">
                ...
                <div class="row py-5">
                    <div class="col-6 col-md-3">
                        <div
                            class="item item-rounded my-4 text-flat bg-flat-lighter"
                        >
                            <i class="fab fa-fw fa-2x fa-vuejs"></i>
                        </div>
                        <h4 class="mb-2">Vue.js 3</h4>
                        <p class="text-muted">
                            The latest version of the progressive JavaScript
                            framework is now in core.
                        </p>
                    </div>
                    <div class="col-6 col-md-3">
                        <div
                            class="item item-rounded my-4 text-danger bg-danger-light"
                        >
                            <i class="fab fa-fw fa-2x fa-laravel"></i>
                        </div>
                        <h4 class="mb-2">Laravel 9</h4>
                        <p class="text-muted">
                            A brand new Laravel 9 with Vite integration version
                            is now included.
                        </p>
                    </div>
                    <div class="col-6 col-md-3">
                        <div
                            class="item item-rounded my-4 text-default bg-default-lighter"
                        >
                            <i class="fa fa-fw fa-2x fa-circle-notch"></i>
                        </div>
                        <h4 class="mb-2">OneUI 5</h4>
                        <p class="text-muted">
                            Based on the design of our best seller dashboard
                            template.
                        </p>
                    </div>
                    <div class="col-6 col-md-3">
                        ...
                        <p class="text-muted">
                            The latest and greatest framework version under the
                            hood.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6">
                            ...
                            <p class="fs-lg fw-medium text-muted mb-0">
                                Either you are building a pure API powered
                                Vue.js app or a Laravel Vue.js based one, we've
                                got you covered.
                            </p>
                        </div>
                        <div
                ...
                <div class="row">
                    <div class="col-6">
                        <BaseBlock transparent class="bg-flat-lighter">
                            <div class="py-4 py-md-7 text-center">
                                <i
                                    class="fab fa-fw fa-5x fa-vuejs text-flat"
                                ></i>
                            </div>
                        </BaseBlock>
                    </div>
                    <div class="col-6">
                        <BaseBlock transparent class="bg-danger-light">
                            <div class="py-4 py-md-7 text-center">
                                <i
                                    class="fab fa-fw fa-5x fa-laravel text-city"
                                ></i>
                            </div>
                        </BaseBlock>
                    </div>
        ...
        <div id="one-vue-power-of-vite" class="bg-body-extra-light">
            <div class="content content-full">
                <div class="py-5">
                    <div class="row mb-5">
                        <div class="col-md-6">
                            ...
                            <p class="fs-lg fw-medium text-muted mb-0">
                                We used the best toolkits and libraries, built
                                by passionate people, to recreate OneUI from
                                scratch and craft a Vue based version.
                            </p>
                        </div>
                        <div
                            class="col-md-6 d-none d-md-flex align-items-md-center justify-content-md-end"
                ...
                <div class="row">
                    ...
                    >
                        <div
                            class="w-100 mb-5 mb-md-0 px-lg-6 position-relative"
                        >
                            <div class="row">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <g stroke="#ecb732">
                                                            <path
                                                                d="m70.5 377.5 74 77M134.5 386.5l-47 50"
                                                            />
                                                        </g>
                                                        <g stroke="#ecb732">
                                                            <path
                                                                d="m297.5 377.5-74 77M233.5 386.5l47 50"
                                                            />
                                                        </g>
                                                        <g stroke="#ffc73b">
                                                            <path
                                                                d="m214.5 207.5-49 49M204.5 256.5l-49-49"
                                                            />
                                                        </g>
                                                    </g>
                                                </g>
                    ...
                    >
                        <div>
                            <div class="d-flex push">
                                <div
                                    class="item item-rounded bg-body flex-shrink-0"
                                >
                                ...
                                <div class="ms-4">
                                    ...
                                    <p class="text-muted">
                                        ...
                                        build tool that aims to provide a faster
                                        and leaner development experience for
                                        modern web projects.
                                    </p>
                                </div>
                            </div>
                            <div class="d-flex push">
                                ...
                                <div class="ms-4">
                                    <h4 class="mb-2">Vue.js 3</h4>
                                    <p class="text-muted">
                                        The latest version of the popular open
                                        source JavaScript framework. An
                                        approachable, performant and versatile
                                        one for building web user interfaces.
                                    </p>
                                </div>
                            </div>
                            <div class="d-flex push">
                                ...
                                <div class="ms-4">
                                    ...
                                    <p class="text-muted">
                                        The latest store library for Vue.js 3
                                        based projects which allows you to share
                                        a state across components/pages.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="py-5 text-center">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <p class="fs-lg fw-medium text-muted mb-0">
                                <a href="https://1.envato.market/AVD6j"
                                    >OneUI</a
                                >
                                is one of the Best Seller and Best Rated admin
                                templates on Themeforest. Its success made
                ...
                <div class="py-5">
                    ...
                    <div class="row items-push">
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            ...
                            <h4 class="mb-2">Bootstrap 5</h4>
                            <p class="text-muted">
                                The latest Bootstrap version now powers OneUI
                                Vue. Amazing new features and utilities are
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            ...
                            <p class="text-muted">
                                OneUI Vue was built with Sass, overriding and
                                extending Bootstrap in an intelligent way to
                                ensure a perfect and modular workflow.
                            </p>
                            <!-- END Sass -->
                        </div>
                        <div class="col-sm-6 col-md-4 col-xl-3">
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            ...
                            >
                                <i
                                    class="fab fa-2x fa-font-awesome text-warning"
                                ></i>
                            </div>
                            <h4 class="mb-2">Font Awesome 6</h4>
                            <p class="text-muted">
                                OneUI Vue comes packed with one of the most
                                popular icon sets, bringing you over 2000
                                freshly made icons for your projects.
                            </p>
                            <!-- END Font Awesome 6 -->
                        </div>
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            ...
                            <p class="text-muted">
                                A set of APIs that allows us to author Vue
                                components using imported functions instead of
                                declaring options. We are also using the
                                <code>&lt;script setup&gt;</code> syntactic
                                sugar.
                            </p>
                            <!-- END Composition API -->
                        </div>
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            ...
                            >
                                <i
                                    class="fa fa-2x fa-file-lines text-default"
                                ></i>
                            </div>
                            <h4 class="mb-2">Prettier</h4>
                            <p class="text-muted">
                                All included files are formatted using the
                                popular opinionated code formatter for the best
                                readability and coding pleasure.
                            </p>
                            <!-- END Prettier -->
                        </div>
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            ...
                            >
                                <i
                                    class="fa fa-2x fa-bolt-lightning text-modern"
                                ></i>
                            </div>
                            <h4 class="mb-2">Lightning Fast HMR</h4>
                            <p class="text-muted">
                                Hot Module Replacement (HMR) that stays fast
                                regardless of app size, providing a faster
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            ...
                            >
                                <i
                                    class="fa fa-2x fa-truck-loading text-success"
                                ></i>
                            </div>
                            ...
                            <p class="text-muted">
                                ...
                                structure your page content or add
                                interactivity.
                            </p>
                            <!-- END Components -->
                        </div>
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            ...
                            <p class="text-muted">
                                Small touches and improvements were introduced
                                throughout the template. From colors to layout
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            ...
                            <p class="text-muted">
                                It is finally here and looks amazing! It was
                                made to work with all color themes and included
                                pages. Choose between light, dark or system
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            ...
                            <p class="text-muted">
                                ...
                                the fly from any view of your application.
                ...
                <div class="py-5">
                    <div class="row mb-5">
                        <div class="col-md-6">
                            ...
                            <p class="fs-lg fw-medium text-muted mb-0">
                                Check out what web developers and people in tech
                                have written about the main OneUI framework.
                            </p>
                        </div>
                        <div
                            class="col-md-6 d-none d-md-flex align-items-md-center justify-content-md-end"
                    ...
                    <div class="row items-push">
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                A combination of flexibility and ease of use.
                                The design is beautiful, but I really value the
                                ease in which I was able to integrate this into
                                my development workflow and platform.
                            </p>
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                While reading the docs i can feel that you
                                literally gave your heart to create this
                                project. It is a high quality piece of work,
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                This is my first purchase on Themeforest and I
                                am delighted. Everything from the design to the
                                code is beautifully crafted and the customer
                                support is great also. Congratulations
                                pixelcave.
                            </p>
                            <p class="fs-sm fw-medium">
                    ...
                    <div class="row items-push">
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                One of the most well thought-through and
                                comprehensive Themeforest templates available.
                                Consistently excellent design and broad feature
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                One of the best paid for downloads I have ever
                                made. Has so many features which have all been
                                designed and put together absolutely
                                brilliantly.
                            </p>
                            <p class="fs-sm fw-medium">
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                This is hands down the best template I have ever
                                come across. It has absolutely everything you
                                need right there laid out and easy to find. I
                    ...
                    <div class="row items-push">
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                After using this Admin template for 6
                                months...we are still delighted. This template
                                has everything. It has obviously been designed
                                with much care and detail. Very intuitive, Easy
                                to use. And we're still finding functionality
                                that we hadn't discovered before. Well done to
                                the developer and thanks for putting your
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                This is the best UI I have ever came across,
                                this UI theme is absolutely perfect in Every Way
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                I have spent two days researching admin themes.
                                There are a couple of really good ones out
                                there, but this one came out at the very top for
                                me. Looks great, on both desktop and mobile, the
                                feature set is amazing, the documentation looks
                                very good. I haven't started implementing yet,
                                but this deserves five stars already.
                            </p>
                            <p class="fs-sm fw-medium">
                                For Design Quality by
                    ...
                    <div class="row items-push">
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                This is one of the best all-around packages I've
                                purchased from ThemeForest. Not only is the
                                Documentation is excellent and well-written, but
                                the code itself is intelligently built and a
                                pleasure to work with. Thanks for doing such
                                great work.
                            </p>
                            <p class="fs-sm fw-medium">
                                For Other by
                    ...
                    <div class="row items-push">
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                Everything's perfect! Good design! Best
                                performance I've ever use! And the best thing,
                                fastest support I've seen! 5 star satisfaction!
                            </p>
                            <p class="fs-sm fw-medium">
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                This is an amazing, multi purpose, and very well
                                designed and structured template. I rarely write
                                a review but this template deserves the support.
                                It is distinguished.
                            </p>
                            <p class="fs-sm fw-medium">
                                For Design Quality by
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                Long story short: I really enjoy using the
                                templates made by pixelcave. The code is very
                                flexible and well structured, the documentation
                                is very good - everything you need.
                            </p>
                            <p class="fs-sm fw-medium">
                                For Code Quality by
                    ...
                    <div class="row items-push">
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                It's awesome, not only the design is marvelous,
                                the code and documentation helps easy
                                customization.
                            </p>
                            <p class="fs-sm fw-medium">
                                For Design Quality by
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-muted mb-2">
                                Awesome code, works really well, well
                                documented!
                            </p>
                            <p class="fs-sm fw-medium">
                                For Flexibility by
                                <span class="fw-semibold"
                                    >corverdevelopment</span
                                >
                            </p>
                        </div>
                    </div>
            ...
            <div class="content content-full">
                <div class="py-5 py-md-8 text-center">
                    ...
                    <Link
                        ...
                        v-click-ripple
                    >
                        <i class="fa fa-fw fa-desktop opacity-50 me-1"></i> Live
                        preview
                    </Link>
                </div>
            </div>
