    ...
    <div class="content">
        ...
        <BaseBlock content-full>
            <div class="row text-center">
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-primary-lighter mx-auto mb-3"
                    ></div>
                    <code>.bg-primary-lighter</code>
                </div>
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-primary-light mx-auto mb-3"
                    ></div>
                ...
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-primary-dark mx-auto mb-3"
                    ></div>
                    <code>.bg-primary-dark</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-primary-darker mx-auto mb-3"
                    ></div>
                    <code>.bg-primary-darker</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-primary-op mx-auto mb-3"
                    ></div>
                    <code>.bg-primary-op</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-primary-dark-op mx-auto mb-3"
                    ></div>
        ...
        <BaseBlock content-full>
            <div class="row text-center">
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-default-lighter mx-auto mb-3"
                    ></div>
                    <code>.bg-default-lighter</code>
                </div>
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-default-light mx-auto mb-3"
                    ></div>
                ...
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-default-dark mx-auto mb-3"
                    ></div>
                    <code>.bg-default-dark</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-default-darker mx-auto mb-3"
                    ></div>
                    <code>.bg-default-darker</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-default-op mx-auto mb-3"
                    ></div>
                    <code>.bg-default-op</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-default-dark-op mx-auto mb-3"
                    ></div>
        ...
        <BaseBlock content-full>
            <div class="row text-center">
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-amethyst-lighter mx-auto mb-3"
                    ></div>
                    <code>.bg-amethyst-lighter</code>
                </div>
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-amethyst-light mx-auto mb-3"
                    ></div>
                    <code>.bg-amethyst-light</code>
                </div>
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-amethyst mx-auto mb-3"
                    ></div>
                    <code>.bg-amethyst</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-amethyst-dark mx-auto mb-3"
                    ></div>
                    <code>.bg-amethyst-dark</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-amethyst-darker mx-auto mb-3"
                    ></div>
                    <code>.bg-amethyst-darker</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-amethyst-op mx-auto mb-3"
                    ></div>
                    <code>.bg-amethyst-op</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-amethyst-dark-op mx-auto mb-3"
                    ></div>
            ...
            <div class="row text-center">
                <div class="col-6 col-md-4 col-xl-2 py-4">
                    <div class="text-amethyst-lighter mb-3">
                        Amethyst Lighter
                    </div>
        ...
        <BaseBlock content-full>
            <div class="row text-center">
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-city-lighter mx-auto mb-3"
                    ></div>
                    <code>.bg-city-lighter</code>
                </div>
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-city-light mx-auto mb-3"
                    ></div>
                ...
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-city-dark mx-auto mb-3"
                    ></div>
                    <code>.bg-city-dark</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-city-darker mx-auto mb-3"
                    ></div>
                ...
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-city-dark-op mx-auto mb-3"
                    ></div>
        ...
        <BaseBlock content-full>
            <div class="row text-center">
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-flat-lighter mx-auto mb-3"
                    ></div>
                    <code>.bg-flat-lighter</code>
                </div>
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-flat-light mx-auto mb-3"
                    ></div>
                ...
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-flat-dark mx-auto mb-3"
                    ></div>
                    <code>.bg-flat-dark</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-flat-darker mx-auto mb-3"
                    ></div>
                ...
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-flat-dark-op mx-auto mb-3"
                    ></div>
        ...
        <BaseBlock content-full>
            <div class="row text-center">
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-modern-lighter mx-auto mb-3"
                    ></div>
                    <code>.bg-modern-lighter</code>
                </div>
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-modern-light mx-auto mb-3"
                    ></div>
                ...
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-modern-dark mx-auto mb-3"
                    ></div>
                    <code>.bg-modern-dark</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-modern-darker mx-auto mb-3"
                    ></div>
                    <code>.bg-modern-darker</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-modern-op mx-auto mb-3"
                    ></div>
                    <code>.bg-modern-op</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-modern-dark-op mx-auto mb-3"
                    ></div>
        ...
        <BaseBlock content-full>
            <div class="row text-center">
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-smooth-lighter mx-auto mb-3"
                    ></div>
                    <code>.bg-smooth-lighter</code>
                </div>
                <div class="col-6 col-md-4 py-4">
                    <div
                        class="item item-circle bg-smooth-light mx-auto mb-3"
                    ></div>
                ...
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-smooth-dark mx-auto mb-3"
                    ></div>
                    <code>.bg-smooth-dark</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-smooth-darker mx-auto mb-3"
                    ></div>
                    <code>.bg-smooth-darker</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-smooth-op mx-auto mb-3"
                    ></div>
                    <code>.bg-smooth-op</code>
                </div>
                <div class="col-6 col-md-4 col-xl-3 py-4">
                    <div
                        class="item item-circle bg-smooth-dark-op mx-auto mb-3"
                    ></div>
        ...
        <BaseBlock content-full>
            <div class="row text-center">
                ...
                <div class="col-6 col-md-3 py-4">
                    <div
                        class="item item-circle bg-success-light mx-auto mb-3"
                    ></div>
                    <code>.bg-success-light</code>
                </div>
                <div class="col-6 col-md-3 py-4">
                    <div
                        class="item item-circle bg-info-light mx-auto mb-3"
                    ></div>
                    <code>.bg-info-light</code>
                </div>
                <div class="col-6 col-md-3 py-4">
                    <div
                        class="item item-circle bg-warning-light mx-auto mb-3"
                    ></div>
                    <code>.bg-warning-light</code>
                </div>
                <div class="col-6 col-md-3 py-4">
                    <div
                        class="item item-circle bg-danger-light mx-auto mb-3"
                    ></div>
        ...
        <BaseBlock content-full>
            <div class="row text-center">
                <div class="col-6 col-xl-2 py-4">
                    <div
                        class="item item-circle bg-gray-lighter mx-auto mb-3"
                    ></div>
                    <code>.bg-gray-lighter</code>
                </div>
                <div class="col-6 col-xl-2 py-4">
                    <div
                        class="item item-circle bg-gray-light mx-auto mb-3"
                    ></div>
                ...
                <div class="col-6 col-xl-2 py-4">
                    <div
                        class="item item-circle bg-gray-dark mx-auto mb-3"
                    ></div>
                    <code>.bg-gray-dark</code>
                </div>
                <div class="col-6 col-xl-2 py-4">
                    <div
                        class="item item-circle bg-gray-darker mx-auto mb-3"
                    ></div>
