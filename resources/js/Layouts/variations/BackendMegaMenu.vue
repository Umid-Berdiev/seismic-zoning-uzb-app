                        ...
                        <div class="p-3">
                            <div class="row g-3 fs-sm">
                                <div class="col-xxl-4">
                                    ...
                                    >
                                        <i
                                            class="fa fa-2x fa-globe-americas opacity-50"
                                        ></i>
                                ...
                                <div class="col-xxl-4">
                                    ...
                                    >
                                        <i
                                            class="fa fa-2x fa-plus text-success opacity-50"
                                        ></i>
                ...
                <div class="dropdown">
                    ...
                    >
                        ...
                        >
                            ...
                            <i
                                class="fa fa-2x fa-box text-white opacity-25 ms-2"
                            ></i>
                        </div>
                        <div class="p-3">
                            <div class="row fs-sm">
                ...
                <div class="dropdown">
                    ...
                    >
                        ...
                        >
                            ...
                            <i
                                class="fa fa-2x fa-cog text-white opacity-25 ms-2"
                            ></i>
                        </div>
                        <div class="p-3">
                            <!-- Quick Settings Form -->
                            <form @submit.prevent>
                                <div class="row fs-sm">
                                    ...
                                    <div
                                        class="col-xxl-6 space-y-4 mt-4 mt-xxl-0"
                                    >
                                        <div>
